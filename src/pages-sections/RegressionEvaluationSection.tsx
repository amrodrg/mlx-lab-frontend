...
import RegressionEvaluationStats from '../components/EvaluationSectionComponents/RegressionEvaluationStats';
...
const RegressionEvaluationSection: FC<Props> = ({loss, mae, accuracy, median, mean}) => {
      ...
      <div className={classes.secondContainer}>
        <div id="nav-tabs">
          ...
          <div className="flex flex-col">
            ...
            <RegressionEvaluationStats loss={loss} mae={mae} accuracy={accuracy} median={median} mean={mean}/>
...
export default RegressionEvaluationSection;
