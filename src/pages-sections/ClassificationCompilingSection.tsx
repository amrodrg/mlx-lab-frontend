...
import ModelCompileBox from '../components/CompileBoxComponents/Classification/ModelCompileBox';
...
const ClassificationCompilingSection: FC<Props> = ({lossFunc, setLosFunc, optimizer, setOptimizer, learningRate, setLearningRate}) => {
...
export default ClassificationCompilingSection;
